...
workflow {
	...
	if (params.ENABLE_PREPROCESS == "enable" ) {
		...
		} else if (params.ENABLE_FASTP != "enable" && params.OVERRIDE_LIST_FASTP != "") {
	...
	} else if ((params.ENABLE_PREPROCESS=="disable" || (params.ENABLE_SGA != "enable" && params.ENABLE_PRINSEQ != "enable"))) {
		// to test
